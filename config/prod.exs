...
# SimpleBlog.Web.Endpoint.load_from_system_env/1 dynamically.
...
config :simple_blog, SimpleBlog.Web.Endpoint,
  on_init: {SimpleBlog.Web.Endpoint, :load_from_system_env, []},
...
# start per endpoint:
#
#     config :simple_blog, SimpleBlog.Web.Endpoint, server: true
#
